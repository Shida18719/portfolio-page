"use client"; // use for interactive component
...
export default function Project({ title, description, tags, imageUrl }: ProjectProps) {
  ...
  return (
    ...
    <section className='group bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden
        rounded-lg sm:pr-8 relative sm:h-[20rem] sm:group-even:pl-8 hover:bg-gray-200 transition dark:bg-white/10 
        dark:text-white dark:hover:bg-white/20'>
            ...
            <Image src={imageUrl} alt="Portfolio Projects" quality={95} 
            className='absolute hidden sm:block -right-40 top-8 w-[28.25rem] rounded-t-lg shadow-2xl
