  ...
  return (
    <section ref={ref}
      ...
      <div className='flex items-center justify-center'>
        <div className="relative">
          ...
          >
                ...
                <Image src="/rashidat-image.jpg" 
                alt="Rashidat's photo" 
      ...
      >
        ...
        <span className="font-bold">Hello, I'm Rashidat.</span> I'm a{" "}
          <span className="font-bold">software developer</span> with{" "}
          <span className="font-bold">1 year</span> of experience. I enjoy
          building <span className="italic">sites & apps</span>. My focus is{" "}
          <span className="underline">Backend Developer
        </span>.
      </motion.h1>
      ...
      >
        ...
        <a className='bg-white px-7 py-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 rounded-full 
        ...
        href='https://www.linkedin.com/in/rashidat-adekoya-668843245/' target='blank'>
          <BsLinkedin />
        </a>

        <a className='bg-white px-7 py-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full 
        ...
        href='https://github.com/Shida18719?tab=repositories' target='blank'>
          <FaGithubSquare />
        </a>
      </motion.div>
    </section>
